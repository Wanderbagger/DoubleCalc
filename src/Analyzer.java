public class Analyzer {
    ...
    public void analyse() throws InputDataException {
        ...
        else if (isSpecialCharacter(line.charAt(0)) && line.charAt(0) != '-') throw new InputDataException("The string starts with an invalid character");
        ...
        else if (containsIncorrectBrackets()) throw new InputDataException("The string contains incorrect brackets number");
        else if (containsIncorrectSequenceWithBrackets()) throw new InputDataException("The string contains incorrect  brackets sequence");
        else if (containsIncorrectSequenceWithBrackets()) throw new InputDataException("The string contains incorrect  brackets sequence");
        }
